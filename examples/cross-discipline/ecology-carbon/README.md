# Carbon pathways in a terrestrial ecosystem

![Final SVG render](figure.png)

[PNG](figure.png) · [Editable SVG](figure.svg) · [Image2 master](image2-master.png) · [Caption](caption.md) · [Sources](sources.md)

51 semantic editable objects, live text and vector geometry. No embedded raster or external SVG resources. Shared generator, renderer and editing instructions are in the [bundle guide](../README.md).
