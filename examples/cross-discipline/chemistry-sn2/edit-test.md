...
1. Imported a local copy of the canonical SVG; 95 semantic objects were available.
2. Changed live `figure-title` to `SN2 substitution` using the text control.
3. Recoloured `r-o` to `#ba6459` using the colour control.
4. Moved `step-to-ts` by x=0, y=8 SVG units using the move controls.
