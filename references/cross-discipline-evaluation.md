...
5. Reconstruct meaningful vectors, render them and inspect the result. When constrained geometry matters, verify actual paths or coordinates as well as metadata. Report material/texture simplifications explicitly.
